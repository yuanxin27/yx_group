...
<div class="navbar">
  ...
  <form action="customerbeforeregister.php" method="post">
  ...
  <div class="inner"><button class="button">Staff Login</button></div>
  </form>
</div>
</div>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <a href="customerstartingpage.php">Dr Strange</a>
